...
export default function AppNavigator() {
  ...
  return (
    <Stack.Navigator 
      ...
      <Stack.Screen name="Home" component={Home} options={{ title: "Seiko Watch Store" }} />
      <Stack.Screen name="Profile" component={Profile} options={{ title: "My Profile" }} />
      <Stack.Screen name="ProductDetails" component={ProductDetails} options={({ route }) => ({ title: route.params?.productName || 'Product Details' })} />
      ...
      <Stack.Screen name="BackendTest" component={BackendTest} options={{ title: "Backend API Test" }} />
      <Stack.Screen name="APITestScreen" component={APITestScreen} options={{ title: "🧪 API Testing Suite" }} />
    </Stack.Navigator>
  );
}
